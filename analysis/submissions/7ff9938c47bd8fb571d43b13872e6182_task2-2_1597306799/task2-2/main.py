...
aaa=open('/vagrant/task2-2/data/aaa.txt','r')
aaa=aaa.read().strip()
aaa=aaa.splitlines()
...
import string
bbb=open('/vagrant/task2-2/data/bbb.txt','r',encoding='latin-1')
...
ccc=open('/vagrant/task2-2/data/ccc.txt','r',encoding='latin-1')
ccc=ccc.read().strip()
ccc=ccc.splitlines()
